...
from .views import ProfileUpdateView, ProfileDetailView, UserRegisterView, \
    UserLoginView, UserLogoutView, UserPasswordChangeView, UserConfirmEmailView, \
    EmailConfirmationSentView, EmailConfirmedView, EmailConfirmationFailedView, \
    UserPasswordResetConfirmView, UserForgotPasswordView

urlpatterns = [
    path('user/edit/', ProfileUpdateView.as_view(), name='profile_edit'),
    path('user/<str:slug>/', ProfileDetailView.as_view(),
         name='profile_detail'),
